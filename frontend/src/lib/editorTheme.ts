  ...
  if (!defined) {
    ...
    monaco.editor.defineTheme('platinum-dark', {
      ...
      colors: {
        ...
        'editor.selectionHighlightBackground': '#1e1f24',
        'editor.wordHighlightBackground': '#1e1f24',
        'editor.wordHighlightStrongBackground': '#1e1f24',
    ...
    monaco.editor.defineTheme('platinum-eye-care', {
      ...
      colors: {
        ...
        'editor.selectionHighlightBackground': '#d5fbe6',
        'editor.wordHighlightBackground': '#d5fbe6',
        'editor.wordHighlightStrongBackground': '#d5fbe6',
  ...
  if (customFg || customBg) {
    ...
    monaco.editor.defineTheme('platinum-custom', {
      ...
      colors: {
        ...
        'editor.selectionHighlightBackground': bg ? `#${bg}` : '#000000',
        'editor.wordHighlightBackground': bg ? `#${bg}` : '#000000',
        'editor.wordHighlightStrongBackground': bg ? `#${bg}` : '#000000',
